...
if __name__ == "__main__":
    tbl2_obdelava = pd.read_excel("./data/module2/2019/LP2019_ODP-obdelava_T2.xlsx", converters={"PREVZETO_OD_MSO_NAZIV": str})
    ...
    tbl5_zbiranje = pd.read_excel("./data/module2/2019/LP2019_ODP-zbiranje_T5.xlsx", converters={"ODDANO_KOMU_SUBJ_ID": str})

    tbl_additional_odpz = pd.read_excel("./data/module2/2019/LP2019_dodatno.xlsx", sheet_name='odp-Z', converters={"MS": str})
    tbl_additional_odpp = pd.read_excel("./data/module2/2019/LP2019_dodatno.xlsx", sheet_name='ODP-P', converters={"MS": str})

    tbl2o_augmented = pd.merge(tbl2_obdelava, tbl_additional_odpp, left_on='ID_SUBJEKTA', right_on='ID_SUBJEKTA').rename(columns={"MS": "OBDELAVEC_MSO", "SIF_ODPADKA": "SIF_ODPADKA_T2"}).drop(columns=["STAT_REGIJA", "SIF_AKTIVNOST"])
    ...
    tbl2o_agg = tbl2o_augmented.groupby(
        by=["ID_POROCILA_x", "ID_SUBJEKTA", "SIF_ODPADKA_T2", "PREVZETO_OD", "PREVZETO_OD_MSO_NAZIV", "DRZAVA_IZVORA",
            "VRSTA_POROCILA", "LETO_POROCANJA", "OBDELAVEC_MSO"],
    ...
    tbl5z_agg = tbl5z_augmented.groupby(
        by=["ID_SUBJEKTA", "SIF_ODPADKA_T5", "ODDANO_KOMU", "ODDANO_KOMU_SUBJ_ID", "TUJ_PREVZEMNIK", "DRZAVA_OBDELAVE_TUJINA", "SIF_AKTIVNOST", "ID_POROCILA_y", "VRSTA_POROCILA", "LETO_POROCANJA", "ZBIRALEC_MSO"],
    ...
    tbl5z2o_join = pd.merge(
        ...
        tbl2o_agg,
        how="outer",
        left_on=["ODDANO_KOMU_SUBJ_ID", "ZBIRALEC_MSO", "SIF_ODPADKA_T5"],
    ...
    tbl5z2o_join.to_excel("./data/module2/2019/LP2019_T2oT5z_joined.xlsx", index=False)
